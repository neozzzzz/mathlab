...
function Calc3Sheet({
  ...
  return (
    <div className="bg-white mx-auto" style={{
      ...
      <div style={{
        borderLeft: "4px solid #ff9800", padding: "8px 12px",
        borderRadius: "0 8px 8px 0", marginBottom: 28, fontSize: ".9rem", fontWeight: 700,
      }}>
        계산해 보세요.
      </div>
  ...
  return (
    <div>
      ...
      <div className="print:hidden max-w-[800px] mx-auto px-8 pt-6">
        <Link href="/calc3" className="inline-block mb-4 text-sm text-gray-400 hover:text-gray-600">← 돌아가기</Link>
      </div>
